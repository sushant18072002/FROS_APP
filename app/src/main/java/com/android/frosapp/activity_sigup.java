                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if (!dataSnapshot.exists()) {
                                ...
                                PhoneAuthProvider.getInstance().verifyPhoneNumber(
                                        ...
                                        activity_sigup.this,        // Activity (for callback binding)
                                        mCallback);
                            } else
                                etPhoneNumber.setError("Phone already register");
                        }
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            Intent intent = new Intent(activity_sigup.this,activity_register.class);
                            intent.putExtra("phone_no",phone_no);
                            intent.putExtra("parent_activity","activity_sign_up");
                            startActivity(intent);
                            finish();
                        } else {
                            Toast.makeText(activity_sigup.this,"Incorrect OTP",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
    ...
    private void StartFirebaseLogin() {
        ...
        mCallback = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationCompleted(PhoneAuthCredential phoneAuthCredential) {
                Toast.makeText(activity_sigup.this,"verification completed",Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onVerificationFailed(FirebaseException e) {
                //Toast.makeText(activity_sigup.this,"verification failed",Toast.LENGTH_SHORT).show();
                Toast.makeText(activity_sigup.this, e.getMessage(),Toast.LENGTH_LONG).show();
            }
            ...
            public void onCodeSent(String s, PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                verificationCode = s;
                Toast.makeText(activity_sigup.this,"Code sent",Toast.LENGTH_SHORT).show();
            }
        };
    }
